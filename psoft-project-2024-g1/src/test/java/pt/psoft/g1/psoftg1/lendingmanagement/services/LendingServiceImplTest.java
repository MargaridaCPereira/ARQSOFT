...
class LendingServiceImplTest {
        ...
        @InjectMocks
        private LendingServiceImpl lendingServiceImpl;
        @Autowired
        ...
        void setUp() {
                ...
                // Setup de géneros
                Genre childrenGenre = new Genre("children");
                Genre juvenileGenre = new Genre("juvenile");
                Genre adultGenre = new Genre("mystery");
        ...
        void testSetReturned() {
                ...
                assertThrows(StaleObjectStateException.class,
                                () -> lendingService.setReturned(year + "/" + seq, request,
